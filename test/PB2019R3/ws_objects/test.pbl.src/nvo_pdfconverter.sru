$PBExportHeader$nvo_pdfconverter.sru
forward
global type nvo_pdfconverter from dotnetobject
end type
end forward
...
global nvo_pdfconverter nvo_pdfconverter

type variables

PUBLIC:
String is_assemblypath = "PdfToImageConverter.dll"
String is_classname = "PdfToImageConverter.PdfConverter"
...
public function string of_convertpdftoimage(string as_pdfpath,string as_outputpath,long al_dpi);
//*-----------------------------------------------------------------*/
//*  .NET function : ConvertPdfToImage
//*   Argument:
//*              String as_pdfpath
...
Try
	...
	ls_result = This.convertpdftoimage(as_pdfpath,as_outputpath,al_dpi)
	Return ls_result
...
public function string of_convertpdftoimagewithpagenames(string as_pdfpath,string as_outputpath,long al_dpi,long al_totalpagesnumber,string as_pagenames[]);
//*-----------------------------------------------------------------*/
//*  .NET function : ConvertPdfToImageWithPageNames
//*   Argument:
//*              String as_pdfpath
//*              String as_outputpath
//*              Long al_dpi
...
/* Set the dotnet function name */
ls_function = "ConvertPdfToImageWithPageNames"
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.convertpdftoimagewithpagenames(as_pdfpath,as_outputpath,al_dpi,al_totalpagesnumber,as_pagenames)
	Return ls_result
Catch(runtimeerror re_error)
...
/* Set the dotnet function name */
ls_function = "ConvertPdfToImageWithPageNamesAndOutputPaths"
...
on nvo_pdfconverter.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_pdfconverter.destroy
